...
if res.status_code == requests.codes.ok:
    ...
    covidFile = open(r"C:\Users\Matth\git\DataAnalysisWorkbooks\Covid19\Data\Raw_data\owid-covid-data.csv", "wb")
...
sheet = wb['Sheet']
p = Path(r"C:\Users\Matth\git\DataAnalysisWorkbooks\Covid19\Data\Raw_data")
myFile = open(p / f"{filename}.csv")
time.sleep(1)

for i, line in enumerate(myFile.readlines()):
    if i % 20000 == 0: print(f'Rows processed: {i}')
